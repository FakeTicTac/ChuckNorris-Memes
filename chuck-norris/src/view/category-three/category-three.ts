 ...
 */
 export class CategoryThree {
    ...
    /**
     * Defines Collection Of Urls to Chuck Norris Images.
     */
    public ChuckImageURLs : string[];
    ...
    constructor(private appState : AppState, private stringHelper : StringHelper) { 
        ...
        // Generate List Of Chuck Norris Photos.
        this.ChuckImageURLs = [
            "https://wallpaperaccess.com/full/1118491.jpg",
            "https://wallpaperaccess.com/full/1118512.jpg",
            "https://wallpaperaccess.com/full/1118653.jpg",
            "https://wallpaperaccess.com/full/1118531.jpg",
            "https://wallpaperaccess.com/full/1118654.jpg",
            "https://wallpaperaccess.com/full/1118675.jpg"
        ]
    }
    ...
    async attached() {
        ...
        this.Category = JSON.parse(JSON.stringify(this.appState.SelectedChuckJokeCategories[2]));
        ...
        // Load Jokes From API.
        this.ChuckJokes = await this.appState.loadJokesFromCategoryAwait(this.appState.SelectedChuckJokeCategories[2], 5);
    }

    /**
     * Method Get Random Chuck Norris Image URL.
     * @returns {string} Image URL.
     */
    getRandomPhoto(): string {
        return this.ChuckImageURLs[Math.floor(Math.random() * this.ChuckImageURLs.length)];
    }
}   